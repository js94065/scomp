...
"3:9,6,4,3,5,4,3:18,6,3:14,2,1:10,3:70,0:2")[0];

	private int yy_rmap[] = unpackFromString(1,8,
"0,1,2,3,4,5,6,1")[0];

	private int yy_nxt[][] = unpackFromString(7,7,
"1,2,3,7,4:2,5,-1:8,2,-1:7,6,-1:8,4:2,-1:7,5,-1,6:3,-1,6:2");
			...
			if (YY_F != yy_next_state) {
				...
				if (YY_NO_STATE == yy_last_accept_state) {
					...
					case -2:
						break;
					case 2:
						{ this.updateLocation(); return new Yytoken(this.currentLine, this.currentColumn, Integer.parseInt(this.yytext())); }
					case -3:
						break;
					case 3:
